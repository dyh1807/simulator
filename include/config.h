...
#define CONFIG_AXI_LLC_PREFETCH_DEGREE 1
#endif
...
constexpr uint32_t AXI_LLC_DEFAULT_LOOKUP_LATENCY = 8u;
constexpr bool AXI_LLC_DEFAULT_PREFETCH_ENABLE =
    CONFIG_AXI_LLC_PREFETCH_ENABLE != 0;
constexpr uint32_t AXI_LLC_DEFAULT_PREFETCH_DEGREE =
    CONFIG_AXI_LLC_PREFETCH_DEGREE > 0 ? CONFIG_AXI_LLC_PREFETCH_DEGREE : 1u;
