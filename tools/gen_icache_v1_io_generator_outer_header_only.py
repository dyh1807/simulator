...
def main() -> int:
    ...
    impl_cpp_path = os.path.join(repo_root, "front-end", "icache", "icache_module.cpp")

    text = generate_outer_header_only(
        include_header="front-end/icache/include/icache_v1_pi_po.h",
        module_type="icache_module_n::ICache",
        pi_po_namespace="icache_module_n::icache_v1_pi_po",
        impl_cpp_path=impl_cpp_path,
        header_guard="IO_GENERATOR_OUTER_H",
        width_type="int",
        function_name="io_generator_outer",
        strip_include_substrings=["include/icache_module.h"],
        wrap_namespace="icache_module_n",
        use_c_linkage=False,
    )
