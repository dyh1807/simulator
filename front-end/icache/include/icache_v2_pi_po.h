...
static constexpr size_t ICacheV2_in_t_BITS = (32 * 1) + (1 * 1) + (1 * 1) + (1 * 1) + (1 * 1) + (20 * 1) + (1 * 1) + (1 * 1) + (1 * 1) + (1 * 1) + (4 * 1) + (32 * (ICACHE_LINE_SIZE / 4));
...
static constexpr size_t ICacheV2_regs_t_BITS = (32 * 1) + (8 * (ICACHE_V2_SET_NUM)) + (1 * (ICACHE_V2_SET_NUM) * (ICACHE_V2_PLRU_BITS_PER_SET)) + (32 * 1) + (8 * 1) + (8 * 1) + (8 * 1) + (1 * (ICACHE_V2_ROB_DEPTH)) + (32 * (ICACHE_V2_ROB_DEPTH)) + (3 * (ICACHE_V2_ROB_DEPTH)) + (32 * (ICACHE_V2_ROB_DEPTH)) + (8 * (ICACHE_V2_ROB_DEPTH)) + (32 * (ICACHE_V2_ROB_DEPTH) * (ICACHE_V2_WORD_NUM)) + (1 * 1) + (32 * 1) + (12 * 1) + (8 * 1) + (32 * (ICACHE_V2_WAYS) * (ICACHE_V2_WORD_NUM)) + (20 * (ICACHE_V2_WAYS)) + (1 * (ICACHE_V2_WAYS)) + (1 * 1) + (32 * 1) + (12 * 1) + (8 * 1) + (2 * (ICACHE_V2_MSHR_NUM)) + (32 * (ICACHE_V2_MSHR_NUM)) + (1 * (ICACHE_V2_MSHR_NUM)) + (4 * (ICACHE_V2_MSHR_NUM)) + (1 * (ICACHE_V2_MSHR_NUM)) + (64 * (ICACHE_V2_MSHR_NUM) * (ICACHE_V2_WAITER_WORDS)) + (1 * (16)) + (1 * (16)) + (8 * (16)) + (1 * (16)) + (4 * 1) + (1 * 1) + (32 * 1) + (4 * 1) + (8 * 1);
