...
void wire_ddr_to_intlv(axi_interconnect::AXI_Interconnect_AXI3 &intlv,
...
void wire_intlv_to_ddr(axi_interconnect::AXI_Interconnect_AXI3 &intlv,
                       sim_ddr_axi3::SimDDR_AXI3 &ddr) {
  ...
  ddr.io.w.wid = intlv.axi_io.w.wid;
...
void clear_master_inputs(axi_interconnect::AXI_Interconnect_AXI3 &intlv) {
...
int main() {
  ...
  if (!accepted || !responded) {
    std::printf("AXI3 smoke demo failed: accepted=%d responded=%d\n",
